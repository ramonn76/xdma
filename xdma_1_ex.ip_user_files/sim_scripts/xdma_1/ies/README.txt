...
#
# Generated by export_simulation on Tue Jun 25 20:02:40 UTC 2019
#
################################################################################
...
'-reset_run' switch to the './xdma_1.sh' script.
...
./xdma_1.sh -noclean_files

For more information on the script, please type './xdma_1.sh -help'.
