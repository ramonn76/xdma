...
#
# Generated by Vivado on Tue Jun 25 20:02:36 UTC 2019
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"/tools/Xilinx/Vivado/2018.3/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"/tools/Xilinx/Vivado/2018.3/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_2 $vlogan_opts +v2k +incdir+"/tools/Xilinx/Vivado/2018.3/data/xilinx_vip/include" \
    "$ref_dir/../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/tools/Xilinx/Vivado/2018.3/data/xilinx_vip/include" \
    "$ref_dir/../../../../xdma_1_ex.srcs/sources_1/ip/blk_mem_gen_0/sim/blk_mem_gen_0.v" \
  2>&1 | tee -a vlogan.log
